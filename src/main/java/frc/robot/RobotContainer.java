  ...
  private Trigger intakeIsAlwaysOnWhenAtRest;
    ...
    public RobotContainer() {
      ...
      intakeOnlyWhileEmpty intakeCommandforSource = new intakeOnlyWhileEmpty(mailbox);
       intakeIsAlwaysOnWhenAtRest = new Trigger(
    ...
    operator
        .a()
        .onTrue(
            elevator.setElevatorToL2Command()
                .andThen(
                new WaitUntilCommand(
                ()-> elevator.isAtAcceptablePosition(elevator.L2_inMotorRotations)).withTimeout(1.25))
                .andThen(
                    new WaitCommand(0.1))
                .andThen(
                    mailbox.MailBox_Outake_Command(mailbox.outakeSpeed))
                .andThen(
                    new WaitUntilCommand(mailbox::nothingInIntake).withTimeout(.5))
                .andThen(
                    elevator.setElevatorToRestCommand())
                );
        ...
        .b()
        .onTrue(
            elevator.setElevatorToL3Command()
                .andThen(
                new WaitUntilCommand(
                ()-> elevator.isAtAcceptablePosition(elevator.L3_inMotorRotations)).withTimeout(1.25))
                .andThen(
                    new WaitCommand(0.1))
                .andThen(
                    mailbox.MailBox_Outake_Command(mailbox.outakeSpeed))
                ...
                .y()
                .onTrue(
                    elevator.setElevatorToL4Command()
                        .andThen(
                        new WaitUntilCommand(
                        ()-> elevator.isAtAcceptablePosition(elevator.L4_inMotorRotations)).withTimeout(1.25))
                        .andThen(
                            new WaitCommand(0.1))
                        .andThen(
                            mailbox.MailBox_Outake_Command(mailbox.outakeSpeed))
