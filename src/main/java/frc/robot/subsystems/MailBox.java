...
// 35/360 * 60
  ...
  public MailBox() {
    ...
    intakeMotor = new SparkMax(Constants.SubsystemConstants.mailbox.intakeMotor, SparkMax.MotorType.kBrushless);

      angleMotor = new TalonFX(Constants.SubsystemConstants.mailbox.angleMotor);
      ...
      slot0Configs.kP = 1.2; // A position error of 10 rotations results in 12 V output  ////Starting low for safety
    ...
    public void setAngleMotor(double motorRotations) {
      ...
      //This allows a Sin curve to be used to calculate the voltage needed to hold the mailbox at a certain angle
  ...
  public Command MailBox_Intake_Command(){
    return this.runOnce(() -> setIntakeMotor(intakeSpeed));
  }

  public Command MailBox_Outake_Command(){
